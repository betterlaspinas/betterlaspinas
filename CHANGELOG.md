...
- Records can now cite more than one source (#243): several Offices take their location and hours from the Citizen's Charter but their phone from the city's key-officials directory, because the charter carries no contact numbers. Each cited document is listed, and an optional `covers` field records which fields a secondary source backs
