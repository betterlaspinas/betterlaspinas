...
### Fixed
- Corrected the Building Permit fee and processing time after verifying `docs/citizens-charter/city-engineer.md` line by line against the source PDF (#213): the fee now names the PD 1096 schedule (₱750 processing + ₱300 filing) instead of a bare "Varies", and the processing time is 5 days (was "5-10 days"), matching the charter's DAY 1 – DAY 5 step table
