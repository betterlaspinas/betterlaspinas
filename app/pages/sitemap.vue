...
const sections = computed<SitemapSection[]>(() => [
  ...
  },
  {
    ...
    links: [
      {
        href: '/offices/civil-registry',
        label: 'Local Civil Registry',
      },
      {
        href: '/offices/city-treasurer',
        label: 'Treasurer\'s Office',
        hidden: true,
      },
      {
        href: '/offices/city-assessor',
        label: 'Assessor\'s Office',
        hidden: true,
      },
      { href: '/offices/city-budget', label: 'Budget Office', hidden: true },
      {
        href: '/offices/city-accounting',
        label: 'Accounting Office',
        hidden: true,
      },
      {
        href: '/offices/city-engineering',
        label: 'Engineering Office',
        hidden: true,
      },
      {
        href: '/offices/city-planning',
        label: 'Planning Office',
        hidden: true,
      },
      {
        href: '/offices/city-agriculture',
        label: 'Agriculture Office',
        hidden: true,
      },
      { href: '/offices/cswdo', label: 'Social Welfare Office', hidden: true },
      {
        href: '/offices/city-health',
        label: 'City Health Office',
        hidden: true,
      },
      { href: '/offices/cdrrmo', label: 'CDRRMO', hidden: true },
      {
        href: '/offices/city-general-services',
        label: 'General Services',
        hidden: true,
      },
      {
        href: '/offices/human-resource-management',
        label: 'HR Management',
        hidden: true,
      },
    ],
