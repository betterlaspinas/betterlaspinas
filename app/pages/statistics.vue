...
<template>
  <div>
    ...
    <!-- City Finance Component -->
    <StatisticsCityFinance :statistics-detailed="statisticsDetailed" />

    <!-- Population Data Component -->
    <StatisticsPopulationData :statistics-detailed="statisticsDetailed" />
