 ...
 * Better Las Piñas Portal - Minimal Professional Design
 */
/* global Chart */
    ...
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        setTimeout(() => {
          ...
          if (countEl) {
            const target = Number.parseInt(countEl.dataset.count)
