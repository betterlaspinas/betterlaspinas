...
(function () {
  ...
  function getCategoryCounts(projects) {
    ...
    projects.forEach((p) => {
      if (p.category.includes('Flood'))
        counts.flood++
      else if (p.category.includes('Road'))
        counts.roads++
      else if (p.category.includes('Water'))
        counts.water++
  ...
  function filterProjects(filter) {
    ...
    return allProjects.filter((p) => {
      if (filter === 'buildings')
        return !p.category.includes('Flood') && !p.category.includes('Road') && !p.category.includes('Water')
      if (filter === 'roads')
        return p.category.includes('Road')
      if (filter === 'flood')
        return p.category.includes('Flood')
      if (filter === 'water')
        return p.category.includes('Water')
      return true
    })
  }
